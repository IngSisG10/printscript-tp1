...
//
//    @Test
//    fun `test function call in expression`() {
...
//
//    @Test
//    fun `test readInput with parameter should throw exception`() {
//        val code = "let input: String = readInput(\"prompt\");" // readInput shouldn't take parameters
//
//        assertThrows(Exception::class.java) {
//            parseCode(code)
//        }
...
//        val declaratorNode = ast[0] as DeclaratorNode
//        val assignmentExpression = declaratorNode.value
//        assertTrue(assignmentExpression is FunctionNode, "println should create a FunctionNode")
//        assertEquals(FunctionEnum.PRINTLN, (assignmentExpression).functionName)
//    }
//
//
//    @Test
