...
class PrintScriptInterpreterTest {
    ...
    fun testVariableDeclarationWithInitialization() {
        ...
        val declarator = DeclaratorNode(variableNode, initialValue, true)
    ...
    fun testTypeMismatchInAssignment() {
        val variableNode = VariableNode("x", TypeEnum.NUMBER)
        val declarator = DeclaratorNode(variableNode, LiteralNode(10.0, TypeEnum.NUMBER), true)
    ...
    fun testVariableRedeclarationThrowsException() {
        ...
        val declarator1 = DeclaratorNode(variableNode1, LiteralNode(10.0, TypeEnum.NUMBER), true)
        val variableNode2 = VariableNode("x", TypeEnum.STRING)
        val declarator2 = DeclaratorNode(variableNode2, LiteralNode("hello", TypeEnum.STRING), true)
    ...
    fun testComplexExpression() {
        ...
        val decl1 = DeclaratorNode(var1, LiteralNode(10.0, TypeEnum.NUMBER), true)
        val decl2 = DeclaratorNode(var2, LiteralNode(5.0, TypeEnum.NUMBER), true)
    ...
    fun testMultipleStatements() {
        ...
        val decl1 = DeclaratorNode(var1, LiteralNode("Hello", TypeEnum.STRING), true)
